    ...
    <>
      ...
      <main className="relative bg-[#fffaf6] dark:bg-gray-950 min-h-screen py-6 sm:py-10 px-4 sm:px-6 md:px-10 lg:px-20">
        <div className="max-w-lg mx-auto text-center py-20">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Failed to load marketplace</h1>
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
            {error?.message || "Something went wrong while loading the marketplace. Please try again."}
          </p>
          <button
            type="button"
            onClick={reset}
