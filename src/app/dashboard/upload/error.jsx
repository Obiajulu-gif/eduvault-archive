  ...
  return (
    <div className="flex items-center justify-center py-24">
      <div className="max-w-lg text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Upload failed</h1>
        <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
          {error?.message ||
            "Something went wrong while uploading your material. This can happen if IPFS pinning or the upload API is temporarily unavailable."}
        </p>
        <button
          type="button"
          onClick={reset}
