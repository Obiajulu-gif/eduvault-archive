  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-bold text-gray-900 dark:text-gray-100">Your Latest Activity</h3>
      ...
      <QueryStateProvider 
        ...
        emptyComponent={
          ...
          <div className="text-center py-8">
            <p className="text-sm text-gray-500 dark:text-gray-400">No activity yet. Start exploring the marketplace!</p>
          ...
          <div className="space-y-5">
            {purchases.slice(0, 5).map((a) => (
              <div key={a._id} className="flex gap-4 items-start group">
                <div className="w-10 h-10 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-950/40 transition-colors">
                  <FaBook className="text-blue-500" />
                </div>
                <div className="flex-1 pb-4 border-b border-gray-50 dark:border-gray-800 group-last:border-0 group-last:pb-0">
